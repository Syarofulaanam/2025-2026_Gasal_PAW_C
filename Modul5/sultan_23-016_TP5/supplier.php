    ...
    <center>
        <table border="1" cellpadding="5" cellspacing="0" style="text-align: center;">
            ...
            <tr class="bawah">
                ...
                <td>
                    <a href="edit_supplier.php?id=<?php echo $row['id']; ?>" class="edit">Edit</a>
                    <a href="hapus_supplier.php?id=<?php echo $row['id']; ?>" class="hapus" onclick="return confirm('Yakin ingin menghapus data ini ?')">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </table>
